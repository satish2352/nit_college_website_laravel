...
<div class="row outer-white">
        ...
        @foreach($data_output as $rules_data)
            <div class="col-sm-12">
                <div>
                    <h2 style="color:blue">{{ $rules_data['academics_name'] }}</h2>
                </div>
                <div>   
                    <p>{{ $rules_data['academics_description'] }}</p>
                </div>
            </div>
        @endforeach
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <p><b>Students from Everywhere :</b><br>
               Thank you for your interest in Late Annasaheb patil Polytechnic. With more than 170 acres of Campus, we have formed a family-oriented Institute ready to welcome and support new members into our community. Founded in 2010 amid. Whether your interest is in our first step program for Diploma, the Late Annasaheb patil Polytechnic admission office looks forward tohelping you better understand our school and its application process. Home at Late Annasaheb patil Polytechnic, we realize that quality students can come from all walks of life and from all sorts of educational backgrounds. So we have created a variety of paths to admission, including a series of admission programs that to learn more about all of our admissions procedure, go to Admission Procedure or contact the Admission Cell or can call at (0253)2024121, 9595952100, 9552551056, 9552551064</p>
        ...
        <div class="col-sm-12">
            <div>
                <h4 style="color:blue">Branches</h4>
            </div>
            <div>   
            <p>
    ...
    Electrical Engineering
        ...
        <div class="col-sm-12">
            <div>
                <h4 style="color:blue">Eligibility for Diploma Admission :</h4>
            </div>
            <div>   
            <p>

        <b>Eligibility criteria for Maharashtra State Candidate in first year</b><br>



Candidate should be an Indian National and should have passed the SSC (Std.X) examination of Maharashtra State Board of Secondary and Higher Secondary Education or its equivalent examination with minimum 35% marks in aggregate* with subjects Math/Mathematics, General Science and English.
        ...
        <br>
           <div class="col-sm-12">
            <div>
                <h4 style="color:blue">Direct Second Year </h4>
            </div>
            <div>   
            <p>

            <b>Eligibility criteria for Maharashtra State Candidates passing HSC science Vocational/Technical</b>
...
2) H.S.C. Vocational means + 2 Level Minimum Competency Vocational course in Engineering Group (MCVC)<br>
3) H.S.C. Technical means + 2 Level Bifocal Program in Engineering Group<br>

<br>
    
    <b>Eligibility criteria for Maharashtra State Candidates passing ITI</b>
...
<br>
    ...
    <b>Eligibility criteria for Maharashtra State Candidates passing ITI (COE)</b>
...
SSC (10th Std) or equivalent examination with subjects English, Maths and Science
AND<br>
ITI (COE) with three modules (Sector Module, Advanced Module and Specialized Module) of 2 years duration.
            ...
            <div class="col-sm-12">
            <div>
                <h4 style="color:blue">Require Documents :</h4>
            </div>
            <div>   
            <p>
    ...
    Original plus two Xerox copies duly attested of all the documents mentioned in the application form<br>
