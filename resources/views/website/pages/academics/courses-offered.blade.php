                        ...
                        <div class="product-type card-shadow p-4">
                            <div >
                                <div class="panel-heading">
                                    <center>
                                    <h3 class="panel-title " style="color:#494680"><b>Courses Offered </b></h3>
                                    </center>
                                            ...
                                            <table id="example"
                                                ...
                                                <thead class="">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="">
                                                            <center>Name of Course</center>
                                                        </th>
                                                        <th scope="col" class="">
                                                            <center>Intake /  Admission Seats</center>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td>
                                                            <center>{{ $data->fld_co_course_name }}</center>
                                                        </td>
                                                        <td>
                                                            <center>{{ $data->fld_co_intake }}</center>
                                                        </td>
                                                    </tr>
                                                    @empty
                                                    {{-- <h4>No Data Found</h4> --}}
