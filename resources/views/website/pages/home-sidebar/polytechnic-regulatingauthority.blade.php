                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <div class="panel panel-primary product-type">
                            <div class="panel-heading">
                                <center><h3 class="panel-title" style="color:blue"><b>Fees Regulating Authority</b></h3></center>
            ...
            <table class="table table-striped table-bordered"  id="customers">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions">
                                        <center>
                                    <a href="../images/fees/<?php echo $fetch['file'];?>" class="btn btn-small btn-primary">
