                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9">
                                <div class="panel panel-primary product-type">
                                    <div class="panel-heading">
                                        <center>
                                            <h3 class="panel-title" style="color:#00ae97"><b>Antiragging Committee</b></h3>
                                        </center>
                                                ...
                                                <table id="example" class="table display responsive nowrap table-striped table-hover table-bordered border-dark" style="width:100%">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th scope="col">
                                                                <div class="d-flex justify-content-center">Mobile Number</div>
                                                            </th>
                                                            <th scope="col">
                                                    ...
                                                    <tbody>
                                                        @forelse ($data_output as $data)
                                                            <tr class="">
                                                                ...
                                                                <td><center>{{ $data->fld_bm_name }}</center></td>
                                                                <td><center>{{ $data->designation_name }}</center></td>
                                                                <td>
