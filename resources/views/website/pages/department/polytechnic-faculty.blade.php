                ...
                $(this).on('keyup', function(e) {
                    ...
                    if (search == '') {
                        ...
                        if ($target.find('tbody tr:visible').size() === 0) {
                            var col_count = $target.find('tr').first().find('td')
                        .size();
                            var no_results = $(
                                '<tr class="filterTable_no_results"><td colspan="' +
                                col_count + '">No results found</td></tr>')
...
<div class="container-fluid bg-#fff" id="iwtPageHeading">
    <div class="container">
        ...
        <div class="col-sm-12" style="padding:0;">
            <marquee>
                <h4 style="color:green"><strong>Humanities & Science Staff Section</strong></h4>
            </marquee>
