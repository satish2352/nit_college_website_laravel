                ...
                <div class="col-md-8 col-sm-12 text-justify" id="iwtContentArea">
                    ...
                    <div class="row outer-white">
                        <div class="col-sm-12">
                            ...
                            <p>Today's engineers and scientists need a well formulated background in applied sciences and
                                humanities in order to make well reasoned decisions involving human values implicit in
                                technical careers and to excel in communication skills in the globally competitive world
                                .The department of Applied science offers a variety of stimulating, specialized and revised
                                subjects that investigate among the natural sciences, technology and humanities. The focus
                                of applied science department is to provide in-depth knowledge of Physics, Chemistry,
                                Mathematics and Communication skills that will form a firm foundation to build engineering
                                and management careers in various disciplines.</p>
                            <p>Department provides an encouraging environment to develop the intellectual capacity, critical
                                thinking, creativity & problem solving ability of the students. Department is taking more
                                focused and multidimensional efforts to make foundation of the students as strong as
                                possible.</p>
                            <p>They are closely associated with first year students for counseling admission work,
                                curricular co and extracurricular activity etc. The department is associated with well
                                `equipped Physics, Chemistry, Electrical laboratories</p>
                            <p></p>
                            <p></p> --}}
                            <div>
