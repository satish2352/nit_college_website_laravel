                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 product-type card-shadow p-4"style=" width:100%">
                                <div >
                                    <div class="panel-heading">
                                        <center>
                                            <h3 class="panel-title" style="color:#494680"><b>Library Staff</b></h3>
                                        </center>
                                                    ...
                                                    <tbody>
                                                        @forelse ($data_output as $data)
                                                            <tr class="">
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <img id="english" src="{{ Config::get('DocumentConstant.LIBRARY_STAFF_VIEW') }}{{ $data->files }}" class=" img-thumbnail  hidden-sm" height="100px" width="100px">
                                                                     </center>
                                                                </td>
