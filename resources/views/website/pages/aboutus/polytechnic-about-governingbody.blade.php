...
<style>
    ...
    <div class="panel_content">
        ...
        <div>
            ...
            <a href="polytechnic-about-mandatary-IOD.php" class="list-group-item ">MANDATARY DISCLOSURE</a>
               <a href="polytechnic-about-aicte-IOD.php" class="list-group-item ">AICTE EOA</a>
              <a href="polytechnic-about-affiliation-IOD.php" class="list-group-item ">MSBTE AFFILIATION</a>
              <a href="polytechnic-about-certificates-IOD.php" class="list-group-item ">AFFILIATION CERTIFICATES</a>
              <a href="polytechnic-about-servicerules-IOD.php" class="list-group-item ">SERVICE RULES</a>
              <a href="polytechnic-about-t&pcell-IOD.php" class="list-group-item ">TRAINING AND PLACEMENT</a>
              <a href="polytechnic-about-antiragging-IOD.php" class="list-group-item ">ANTIRAGGING COMMITTEE</a>
              <a href="polytechnic-about-internalcomplaint-IOD.php" class="list-group-item ">INTERNAL COMPLAINT COMMITTEE</a>
              <a href="polytechnic-about-redressal-IOD.php" class="list-group-item ">GRIEVANCE REDRESSAL COMMITTEE</a>
              <a href="polytechnic-about-scst-IOD.php" class="list-group-item ">SC/ST CELL</a>
              <a href="polytechnic-about-calendar-IOD.php" class="list-group-item ">ACADEMIC CALENDAR</a>
              <a href="polytechnic-about-regulatingauthority-IOD.php" class="list-group-item ">FEES REGULATING AUTHORITY</a>
              <a href="polytechnic-about-terms-IOD.php" class="list-group-item ">TERMS AND CONDITIONS</a>
              <a href="polytechnic-about-downloads-IOD.php" class="list-group-item ">STUDENT DOWNLOADS</a>
              <a href="polytechnic-about-downloadsstaff-IOD.php" class="list-group-item ">STAFF DOWNLOADS</a>
              <a href="polytechnic-about-scholarship-IOD.php" class="list-group-item ">STUDENT SCHOLARSHIP</a>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <div class="panel panel-primary product-type">
                            <div class="panel-heading">
                                <center><h3 class="panel-title" style="color:blue"><b>Governing Body Members</b></h3></center>
