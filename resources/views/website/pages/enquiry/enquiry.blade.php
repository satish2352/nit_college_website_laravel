        ...
        <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-11 p-2 pb-5">
                ...
                <div class="well well-sm"
                    style=" box-shadow: 0 8px 17px 2px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12), 0 5px 5px -3px rgba(0, 0, 0, 0.2);">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="regForm" action="{{ route('add-enquiry') }}">
                        ...
                        <div class="row"
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group py-2">
                                    <label for="admission_level"><b>Admission Level</b> <i
                                            class="required">*</i></label>
                                    <select class="form-control" name="admission_level" id="admission_level">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('admission_level') == 'FY' ? 'selected' : '' }}>FY
                                        </option>
                                        <option value="2" {{ old('admission_level') == 'DSY' ? 'selected' : '' }}>DSY
                                        </option>
                                    </select>
                                ...
                                <div class="form-group py-2">
                                    ...
                                    <select class="form-control" id="source" name="source">
                                        ...
                                        <option value="Directly Institute Visit"
                                            {{ old('source') == 'Directly Institute Visit' ? 'selected' : '' }}>Directly
                                            Institute Visit</option>
                                        <option value="website" {{ old('source') == 'website' ? 'selected' : '' }}>
                                            Website</option>
                                        <option value="radio/newspaper"
                                            {{ old('source') == 'radio/newspaper' ? 'selected' : '' }}>Radio/Newspaper
                                        </option>
                                        <option value="staff" {{ old('source') == 'staff' ? 'selected' : '' }}>Staff
                                        </option>
                                        <option value="student" {{ old('source') == 'student' ? 'selected' : '' }}>
                                            Student</option>
                                    </select>
                                ...
                                <div class="form-group py-2">
                                    ...
                                    <input type="text" class="form-control" id="source_name" name="source_name"
                                        placeholder="Enter source name" value="{{ old('source_name') }}" />
