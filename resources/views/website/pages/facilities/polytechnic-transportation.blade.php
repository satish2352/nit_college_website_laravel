...
<div class="row outer-white">
        <div class="col-sm-12">
            ...
            <div>
                <h4 style="color:blue">Transportation</h4>
            </div>
            <div>    
            <p>
    ...
    The College has adequate buses which are made available to the students and the faculty members for commuting from various points in the Nashik city .<br>
    Institute provides transport facility to our students through a fleet of buses, covering almost all major landmarks in Nashik .<br>
    No profit No loss basis.<br>
    Bus root covers CIDCO, Satpur, Nashik Road, Mumbai Naka, Indiranagar, Vijay Nagar, Patahrdi Phata almost all major routes in Nashik city.
...
<i>Last updated on : 21-02-2019 12:03 PM</i>
	...
	<div>
		 <!--<img src="../visitors/library.gif" alt="" class="img-responsive" style="margin-top:30px; margin-bottom:30px; height:200px; width:200px;">-->
	 	</div>
	</div>
