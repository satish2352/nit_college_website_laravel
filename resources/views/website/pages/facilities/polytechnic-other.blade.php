...
<div class="row outer-white">
        <div class="col-sm-12">
            ...
            <div>
                <h4 style="color:blue">Other Facilities</h4>
            </div>
            <div>    
            <p>
    
      <b>College Canteen</b><br> 

    A separate college canteen for students and staff. <br>
    
    <b>College Gym</b><br>

    A specious and well equipped GYM for students only.<br>
    Body Instructor for GYM students.<br>
    
    <b>Generator</b><br>
  A Generator has been installed for extra power backup. 
