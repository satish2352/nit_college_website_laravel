                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse d-flex justify-content-center itemfromstart" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown"><a class="nav-link" href="{{ route('achievement') }}">Achievements</a></li>
                                    <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item dropdown ">
                                        ...
                                        <ul class="dropdown-menu spaceacademic " aria-labelledby="AcademicsDropdown">
                                            <li class="nav-item aaaa"><a class=" aaab dropdown-item  " href="{{ route('polytechnic-rules') }}">Admission Rules And
                                                    Process</a></li>
                                        </ul>
                                    </li>
