						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">Grievance Redressal Committee Members</a></li>
							...
							<tbody>
                                ...
                                <tr>
									...
									<td>
                                        ...
                                        <a href="redressal_delete.php?fld_bm_id=<?php echo $fetch['fld_bm_id'] ?>" onclick="return confirm('Are you sure to Delete Grievance Redressal Committee Members')" class="fa fa-trash-o"  style="color: red;font-size: 20px;">
                                        </a>
									</td>
